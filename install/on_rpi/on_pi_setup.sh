...
cd /home/matthew/bthidhub/install/on_rpi/bluez
autoreconf -fvi
...
sudo make install
sudo python3 /home/matthew/bthidhub/install/on_rpi/config_replacer.py
sudo cp /home/matthew/bthidhub/install/on_rpi/sdp_record.xml /etc/bluetooth/sdp_record.xml
sudo cp /home/matthew/bthidhub/install/on_rpi/input.conf /etc/bluetooth/input.conf
sudo cp /home/matthew/bthidhub/install/on_rpi/main.conf /etc/bluetooth/main.conf

sudo cp /home/matthew/bthidhub/install/on_rpi/remapper.service /lib/systemd/system/remapper.service
